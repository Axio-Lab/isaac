    ...
    <div className="flex items-center justify-center min-h-screen w-full px-4 bg-background">
      <div className="w-full max-w-sm border border-border rounded-xl p-5 bg-card">
        ...
        <button
          ...
          className="w-full h-9 border border-border rounded-lg text-xs flex items-center justify-center gap-2 hover:bg-muted transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {socialLoading ? (
            <>
